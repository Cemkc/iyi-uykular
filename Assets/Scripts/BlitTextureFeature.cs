...
public class BlitTextureFeature : ScriptableRendererFeature
{
    class RenderPass : ScriptableRenderPass
    {
        ...
        public RenderPass(string profilingName, Material material, int passIndex, RenderTexture renderTexture) : base()
        {
    ...
    {
        this.renderPass = new RenderPass(name, settings.material, settings.materialPassIndex, settings.renderTexture);
